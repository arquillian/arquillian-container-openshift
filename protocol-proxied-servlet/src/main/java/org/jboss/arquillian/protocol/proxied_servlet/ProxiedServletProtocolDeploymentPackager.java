 ...
 * @version $Revision: $
 */
public class ProxiedServletProtocolDeploymentPackager implements DeploymentPackager
{
   /* (non-Javadoc)
...
public Archive<?> generateDeployment(TestDeployment testDeployment, Collection<ProtocolArchiveProcessor> processors)
   {
      ...
      throw new IllegalArgumentException(ProxiedServletProtocolDeploymentPackager.class.getName()  +
