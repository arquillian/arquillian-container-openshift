...
import org.jboss.arquillian.container.openshift.ping.AS7PingArchive;
...
/**
 * OpenShift container. Deploys application or descriptor to an existing OpenShift instance. This instance must be
 ...
 *
 */
public class OpenShiftContainer implements DeployableContainer<OpenShiftContainerConfiguration>
{
   private static final Logger log = Logger.getLogger(OpenShiftContainer.class.getName());
   ...
   @Inject
   @ContainerScoped
   private InstanceProducer<OpenShiftContainerConfiguration> configuration;
   ...
   @Override
   public Class<OpenShiftContainerConfiguration> getConfigurationClass()
   {
      return OpenShiftContainerConfiguration.class;
   }

   @Override
   public void setup(OpenShiftContainerConfiguration configuration)
   {
   ...
   public void start() throws LifecycleException
   {
      ...
      log.info("Preparing Arquillian OpenShift container at " + conf.getRootContextUrl());
   ...
   public void stop() throws LifecycleException
   {
      ...
      log.info("Shutting down Arquillian OpenShift container at " + conf.getRootContextUrl());
   ...
   /**
    * Returns a credentials provider for OpenShift. If no implementation is found, it returns a configuration based
    * one.
    *
