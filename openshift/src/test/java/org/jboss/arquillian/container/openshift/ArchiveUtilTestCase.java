...
public class ArchiveUtilTestCase {
    ...
    public void testWarContent() {
        ...
        Assert.assertEquals("Transformation from path to className",
                "org.jboss.arquillian.container.openshift.servlet.Servlet1", classes.iterator().next());
    ...
    public void testWarClassLoader() {
        ...
        Assert.assertEquals("Transformation from path to className",
                "org.jboss.arquillian.container.openshift.servlet.Servlet1", servlets.iterator().next().getName());
    }
